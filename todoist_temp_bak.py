...
def todoist_time_to_datetime_datetime(time_string):
    try:
...
def item_for_today(item_obj):
    ...
    for item in items:
        if item["is_archived"]:
            ...
            todo_time = todoist_time_to_datetime_datetime(item['due_date_utc'])
            ...
            if end_of_today_aware > todo_time_aware:
                Print.colored(end_of_today_aware, ">", todo_time_aware, "red")
                return "overdue"
            elif end_of_today_aware == todo_time_aware:
                Print.colored(end_of_today_aware, "==", todo_time_aware, "yellow")
                return "today"
            elif end_of_today_aware < todo_time_aware:
                Print.colored(end_of_today_aware, "<", todo_time_aware, "green")
                return "not today"
        # else:
        #     return False
