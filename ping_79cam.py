...
__logfile__ = path_extend(currentfolder(), "ping_.py.log")


domains = ['192.168.89.79'] # notebook1
errDomains = 0 # количество заведомо плохих доменов
timeout = "5000" # таймаут пинга в мс
time_sleep = 1 # задержка перед новым проходом в с
...
def main():
    ...
    while True:
        ...
        for hostname in domains: # сопсна, пинговка
            ...
            response = ping(hostname, quiet = True, count = 2)
